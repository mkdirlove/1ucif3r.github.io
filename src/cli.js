...
const struct = {
  root: ['about', 'contact', 'github'],
  hritik: ['pubg', 'other'],
};

const commands = {};
let systemData = {};
const rootPath = 'users/1ucif3r/root';
...
$(() => {
  ...
  pages.push($.get('pages/github.html'));
  pages.push($.get('pages/help.html'));
  pages.push($.get('pages/hritik.html'));
  pages.push($.get('pages/other.html'));
  pages.push($.get('pages/pubg.html'));
  ...
  $.when
    ...
    .done(
      (
        ...
        systemData['github'] = githubData[0];
        systemData['help'] = helpData[0];
        systemData['hritik'] = hritikData[0];
        systemData['other'] = otherData[0];
        systemData['pubg'] = pubgData[0];
